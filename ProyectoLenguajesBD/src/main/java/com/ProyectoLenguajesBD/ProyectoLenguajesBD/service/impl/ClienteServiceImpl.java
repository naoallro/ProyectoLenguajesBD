...
public class ClienteServiceImpl implements ClienteService {
    ...
    public ClienteServiceImpl(ClienteDao dao){ this.dao = dao; }

    @Override @Transactional(readOnly = true)
    public List<Cliente> getClientes(){ return dao.findAll(); }

    @Override @Transactional(readOnly = true)
    public List<Cliente> getClientesActivos(){ return dao.findByEstado("A"); }

    @Override @Transactional(readOnly = true)
    public Cliente getCliente(Long id){ return dao.findById(id).orElse(null); }

    @Override @Transactional
    public void save(Cliente c){ dao.save(c); }
